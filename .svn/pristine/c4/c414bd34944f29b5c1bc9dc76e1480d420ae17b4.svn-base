...
class GenerosControllerTest < ActionController::TestCase
  ...
  test "should create genero" do
    assert_difference('Genero.count') do
      post :create, genero: { descricao: @genero.descricao, familia_id: @genero.familia_id, status: @genero.status }
    end
  ...
  test "should update genero" do
    put :update, id: @genero, genero: { descricao: @genero.descricao, familia_id: @genero.familia_id, status: @genero.status }
    assert_redirected_to genero_path(assigns(:genero))
  end
