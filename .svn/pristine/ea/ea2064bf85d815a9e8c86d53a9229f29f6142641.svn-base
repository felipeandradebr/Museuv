...
class FamiliaControllerTest < ActionController::TestCase
  ...
  test "should create familium" do
    assert_difference('Familium.count') do
      post :create, familium: { descricao: @familium.descricao, ordem_id: @familium.ordem_id, status: @familium.status }
    end
  ...
  test "should update familium" do
    put :update, id: @familium, familium: { descricao: @familium.descricao, ordem_id: @familium.ordem_id, status: @familium.status }
    assert_redirected_to familium_path(assigns(:familium))
  end
