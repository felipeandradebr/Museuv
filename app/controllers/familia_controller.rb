...
class FamiliaController < ApplicationController
  ...
  def create
    ...
    respond_to do |format|
      if @familium.save
        format.html { redirect_to familia_path, notice: 'Familium was successfully created.' }
  ...
  def update
    ...
    respond_to do |format|
      if @familium.update_attributes(params[:familium])
        format.html { redirect_to familia_path, notice: 'Familium was successfully updated.' }
